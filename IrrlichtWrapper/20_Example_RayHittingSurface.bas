...
IrrSetWindowCaption( "Example 20: Getting the point of collision" )
...
CollisionGroup = IrrGetCollisionGroupFromBox( SceneNode )
...
WHILE IrrRunning
    ...
    IrrGetCollisionPoint( StartVector, EndVector, CollisionGroup, CollideAt )

    ' move the test object to this location to indicate the point of collision
    IrrSetNodePosition( TestNode, CollideAt.x, CollideAt.y, CollideAt.z )
