...
'' it then adds the mesh as a new node and applies a material to it. Finally
...
IrrSetWindowCaption( "Example 24: Writing a custom mesh to a file" )
...
IrrWriteMesh( Mesh, EMWT_IRR_MESH, ".\mymesh.txt" )
