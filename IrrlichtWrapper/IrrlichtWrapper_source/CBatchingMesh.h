...
public:
    ...
    void setHardwareMappingHint(irr::scene::E_HARDWARE_MAPPING newMappingHint, irr::scene::E_BUFFER_TYPE buffer=EBT_VERTEX_AND_INDEX);
    void setDirty(irr::scene::E_BUFFER_TYPE buffer=EBT_VERTEX_AND_INDEX);
