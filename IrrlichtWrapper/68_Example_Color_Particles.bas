...
IrrSetWindowCaption( "Example 68: Highly colored particles with the color affector" )
...
SmokeEmitter.min_paritlcles_per_second = 30
SmokeEmitter.max_paritlcles_per_second = 50
...
IrrAddGravityParticleAffector ( SmokeParticles.particles, 0.0, 0.075, 0.0 )
...
IrrAddColorMorphAffector ( _
		SmokeParticles.particles, 5, @colors(0), @times(0), IRR_ON )
